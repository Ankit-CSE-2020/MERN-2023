...
import { deleteItemFromCartAsync, selectItem, updateCartAsync } from '../cart/cartSlice';
...
const handleOrder=(e)=>{
  const order={
    ...
    paymentMethod,
    selectAddress,
    status:'pending',   //other status can be delivered , recived. 
  }
    ...
    return(
      <>
       ...
       <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <form className='bg-white p-3 mt-12' noValidate onSubmit={handleSubmit((data)=>{
            console.log(data);
            dispatch(
      ...
      {user. addresses.map((address,index) => (
        <li key={index} className="flex justify-between gap-x-6 py-5 px-2 border">
