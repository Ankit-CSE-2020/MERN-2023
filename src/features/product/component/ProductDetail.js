...
import { InfinitySpin } from 'react-loader-spinner'
  ...
  //TODO : In server data we will and colors ,size ,highlights etc.
const colors= [
...
export default function ProductDetail() {
  ...
  const params=useParams()          //ye apne aap url se id nikaal leta hai (hook)
  ...
  const handleCart =(e)=>{
       ...
       if(items.findIndex(item=>item.productId===product.id)<0){
         ...
         alert.success("Item Successfuly Added To Cart");
       }
       else{
