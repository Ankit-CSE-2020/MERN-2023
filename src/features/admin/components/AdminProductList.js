...
import { ChevronDownIcon,ChevronLeftIcon, ChevronRightIcon, FunnelIcon, MinusIcon, PlusIcon, StarIcon, Squares2X2Icon } from '@heroicons/react/20/solid'
import {  } from '@heroicons/react/20/solid'


import { useSelector, useDispatch } from 'react-redux';
import {fetchAllProductAsync,
  fetchBrandsAsync,
...
const handleFilter=(e,section,option)=>{
  const newFilter={...filter};
     //TODO : on serevr we support multi values/categories
  if(e.target.checked){
    ...
    <div className="bg-white">
      <div>
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              ...
              <div>
                ...
                className="rounded-md mx-10 bg-green-600 px-3 py-2 my-3 text-sm font-semibold text-white"
         ...
         {/* Section and product filter end  */}
          ...
          {products.map((product) => (
            ...
            <div key={product.id} className="group relative border p-1">
              ...
              <div className="mt-4 flex justify-between">
                ...
                <p className="mt-1 text-sm text-gray-500"><StarIcon className='w-6 h-5 inline'></StarIcon>  <span className='align-bottom'>{product.rating}</span></p>
                </div>
                <div>
            ...
            <div className='my-4'>
                <Link to={`/admin/product-form/edit/${product.id}`} className="rounded-md bg-indigo-600 px-3 py-2  text-sm font-semibold text-white"
                >Edit Product
                </Link>
                </div>
            </div>
